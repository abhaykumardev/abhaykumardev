...
* 🧩 Solved **300+ DSA problems** (LeetCode & CodeStudio)
* 🔧 Building **scalable web apps & REST APIs**
* 🤖 Exploring **AI with real-world implementations**
* 🎯 Goal: Crack top internships & become a strong **SDE**
...
* Developed a **real-world inspired food delivery UI**
